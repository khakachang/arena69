...
func drop_item():
	...
	if drop_number == 1:
		var gem1 = gem_scene.instantiate()
		var gem2 = gem_scene.instantiate()
		var gem3 = gem_scene.instantiate()
		gem1.position = position
		gem2.position = position + Vector2(20,0)
		gem3.position = position + Vector2(0,20)
		get_parent().add_child(gem1)
		get_parent().add_child(gem2)
		get_parent().add_child(gem3)
	queue_free()
